...
<head>
  <meta charset="UTF-8"/>
  <title>ITMD 4/515 &mdash; Lab 1</title>
  ...
  <div class="wrapper">
    ...
    <section>
      ...
      <img
        ...
        src="https://github.com/hanggrian/hanggrian.github.io/raw/main/images/logo.png"/>
      <p>
        Greetings, friends! I'm <strong>Hendra</strong>, a graduate student from Indonesia.
        &#127470;&#127465;
      </p>
      <p>
        Welcome to my first JSP files. Although I am comfortable with Java, web development is not
        my strong suit. I'm looking forward to learning something new in this course! &#127891;
      </p>
      <table>
        <tr>
          <th>Information</th>
      ...
      <h2>Latest Work</h2>
      <p>
        The purpose of this section is to exhibit servlet requests and handle responses
        appropriately, using my latest open-source libraries as sample data. In this example, the
        <b>dark mode preference</b> will be applied to the next page.
      </p>
      <ul>
      ...
      <p>
        This website uses
        <a href="https://github.com/hanggrian/minimal-dark-theme/">Minimal Dark</a> and
        <a href="https://github.com/hanggrian/cayman-dark-theme/">Cayman Dark</a> website themes.
        They were originally forked from
        <a href="https://github.com/orderedlist/minimal">Minimal</a> and
        <a href="https://github.com/jasonlong/cayman-theme">Cayman</a> to include dark mode
        settings.
      </p>
    </section>
    <footer>
